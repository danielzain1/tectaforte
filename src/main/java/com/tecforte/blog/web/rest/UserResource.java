...
import com.tecforte.blog.service.dto.Keyword;
...
public class UserResource {
    ...
    public ResponseEntity<String> createKeyword( @RequestBody Keyword keyword) throws URISyntaxException {
    	String i  = keyword.toString();

        if (keyword.getKeyword() != null) {
        	throw new BadRequestAlertException("Invalid Content", "Entity_name", "Invalid Content");
            // Lowercase the user login before comparing with database
        }
//        else if (userRepository.findOneByLogin(userDTO.getLogin().toLowerCase()).isPresent()) {
//            throw new LoginAlreadyUsedException();
...
//        } 
           ...
           return ResponseEntity.created(new URI("/keyword/test/" ))
                .headers(HeaderUtil.createAlert(applicationName, i, "A user is created with identifier " ))
                .body(i);
        }
    }
